...
<body>
	...
	<form action="insert_product.php" method="post" enctype ="multipart/form-data">
		...
		<table align="center" width="750" border="2" bgcolor="skyblue">
			<tr align="center" >
			<td colspan="7"><h2> İnsert new post here</h2></td>
			</tr>
			
			<tr>
			<td align="right"><b>Ürün Başlık: </b></td>
			<td><input type="text" name="product_title" required /></td>
			</tr>
			
			<tr>
			<td align="right"><b>Ürün Kategori: </b></td>
			<td>
			...
			<tr>
			<td align="right"><b>Ürün Marka:</b></td>
			<td>
			...
			<tr>
			<td align="right"><b>Ürün Fiyat:</b></td>
			<td><input type="text" name="product_price" required /></td>
			</tr>
			
			<tr>
			<td align="right"><b>Ürün Açıklama:</b></td>
			<td><textarea name="product_desc" cols ="18" rows ="10" ></textarea></td>
			</tr>
			
			<tr>
			<td align="right"><b>Ürün Anahtar:</b></td>
			<td><input type="text" name="product_keywords" required /></td>
			</tr>
			
			<tr align="center">
			<td colspan="7"><input type="submit" name="insert_post" value ="Ürün Ekle" /></td>
			</tr>
